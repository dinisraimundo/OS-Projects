...
int sub_key(HashTable *ht, const char * key, const char * client_id, int fd_notif){
    ...
    while (keyNode != NULL) {
        if (strcmp(keyNode->key, key) == 0) {
            ...
            //  If we get here the client wasn't subscribed to this key and we are
            //  going to subscribe him
...
/*
    This function iniciates the subscription of the key in the Client struct
*/
...
/*
    This function deletes the subscription of the key from the Client struct
*/
...
/*
    This function removes every subscription from the HashTable
*/
